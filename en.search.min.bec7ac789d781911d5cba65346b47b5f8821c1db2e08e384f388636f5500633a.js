...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.eece2e47f7cecf331fd29a476167f95c27a461ac5f16a4d3bad6994fc97c36fd.js',function(){input.required=false;search();});}
